...
# EMAIL: mapres21@gmail.com
# TWITTER:
# FECHA DE LANZAMIENTO DE LA PRIMERA VERSIÓN (1.0): 19/02/2016
# FECHA DE LANZAMIENTO DE LA VERSIÓN ACTUAL (1.0): 19/02/2016
# FECHA DE ULTIMA ACTUALIZACIÓN: 19/02/2016
###########################################################
###########################################################
...
echo "----------------------------------"
sudo pacman -S fish #Comando para instalarlo desde packages
...
echo "----------------------------------"
sudo pacman -S ranger #Comando para instalarlo desde packages
...
echo "----------------------------------"
sudo pacman -S python2-scipy #Comando para instalarlo desde packages
...
echo "----------------------------------"
sudo pacman -S python-matplotlib #Comando para instalarlo desde packages
...
echo "----------------------------------"
sudo pacman -S gnuplot #Comando para instalarlo desde packages
...
echo "----------------------------------"
sudo pacman -S ipython #Comando para instalarlo desde packages
...
echo "----------------------------------"
yaourt -S pycharm-community #Comando para instalarlo desde AUR
...
echo "----------------------------------"
yaourt -S atom-editor #Comando para instalarlo desde AUR
...
echo "----------------------------------"
sudo pacman -S gparted #Comando para instalarlo desde packages
...
echo "-       Installing VLC           -"
echo "----------------------------------"
sudo pacman -S vlc #Comando para instalarlo desde packages
echo "VLC Installed"
...
echo "-------------------------------------"
yaourt -S popcorntime-community #Comando para instalarlo desde AUR
...
echo "---------------------------------------"
yaourt -S imagewriter #Comando para instalarlo desde AUR
...
echo "----------------------------------"
sudo pacman -S stellarium #Comando para instalarlo desde packages
...
echo "----------------------------------"
sudo pacman -S skype #Comando para instalarlo desde packages
...
echo "----------------------------------"
yaourt -S spotify #Comando para instalarlo desde AUR
...
echo "----------------------------------"
yaourt -S google-chrome #Comando para instalarlo desde AUR
...
echo "----------------------------------"
sudo pacman -S gimp #Comando para instalarlo desde packages
echo "Gimp Installed"
...
echo "----------------------------------"
sudo pacman -S wine #Comando para instalarlo desde packages
echo "Wine Installed"
...
echo "----------------------------------"
sudo pacman -S K3b #Comando para instalarlo desde packages
echo "K3b Installed"
...
echo "----------------------------------"
sudo pacman -S virtualbox #Comando para instalarlo desde packages
...
echo "----------------------------------"
yaourt -S megasync #Comando para instalarlo desde AUR
...
echo "----------------------------------"
sudo pacman -S dnsmasq #Comando para instalarlo desde AUR
